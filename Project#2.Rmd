...
The confusion matrix shows that the model only had an accuracy of 65.19%, with high sensitivity of 65.84% and specificity of 64.55%. To answer our business question of which factors affect attrition, this model was not very useful because it has a high quantity of false negatives, misidentifying many employees left as those who were not at risk of leaving the company.
=======
...
According to the summary of our decision tree, we found that the industryIT factor seems to be the most important factor in determining employee turnover, followed by industryBuilding, trafficreferal, trafficfriends, and wayfoot. The least important factor was trafficempjs. 
