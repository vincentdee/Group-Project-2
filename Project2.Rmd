...
library(gmodels)
library(kernlab)
svm_model <- ksvm(event ~ ., data = turnoverNorm, kernel = "rbfdot")
#Accuracies:
#rbfdot: 0.7733
#polydot: 0.6652
#laplacedot: 0.6873
...
Our SVM model predicted 529 individuals would leave, of which 362 actually left. It missed 167 who were predicted to stay but actually left. The sensitivity is 77.49% and the specificity is 77.16%. Overall, our SVM model was 77.33% accurate.
...
To conclude, we were able to achieve our goals of \
  (1) identifying contributory factors in employee turnover, and \
  (2) determining the most accurate models. 

The most important factors are industry and traffic, and the most useful model is decision tree (or stacked model which was solely based off decision tree). From our results, IT, building, and banking industries have the highest effect on turnovers. There is a lowest possibility of turnover in IT industry, and highest possibilities in building and banking. For future decision making, industries that are in industries of high turnovers might find it helpful to compare themselves with industries with low turnovers and further analyze the differences.

Some differences in industries are, however, irreconcilable simply due to the nature of different fields. Banking, for example, is notorious for having long, grueling hours and the industry is tailor-made for analysts to quit after a few years. Thus, industry-wide sweeping changes may or may not be feasible. Instead, industries like banking may want to be more selective in hiring candidates to begin with, so that those who are selected are wholly committed to the job.

Regarding traffic, "Referral" was the single most important metric. Surprisingly, referrals have a higher chance of turnover compared to non-referrals. We speculate that this may be due to the fact that prospective employees become enamored by their connection's endorsement of the company, and upon beginning to work for said company, become disenfranchised and unhappy. Psychologists have shown that framing the equivalent situation as a loss or a gain significantly impacts how people see the situation: having low expectations of the company and arriving to find it's a little better than anticipated is generally viewed more favorably than holding high expectations only to have said expectations lowered upon arrival. Additionally, friends' endorsement of their company may be disingenuous if they are incentivized for referrals with bonuses.

All in all, our model provides a framework for companies to go off of; by looking at influential factors influencing employee turnover, companies can proactively take preventative measures in efforts to retain talent, saving employee hiring and training costs in the short term and benefiting the bottom line as well as company culture in the long term.
